...
import com.glitchcam.vepromei.edit.background.view.TransformView;
import com.glitchcam.vepromei.edit.view.DrawRect;
import com.glitchcam.vepromei.edit.watermark.EffectItemData;
import com.glitchcam.vepromei.makecover.ClipImageView;
...
import static com.glitchcam.vepromei.utils.Constants.BLUR;
...
import static com.glitchcam.vepromei.utils.Constants.MOSAIC;
...
public class VideoFragment extends Fragment {
    ...
    private Handler m_handler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message msg) {
            ...
            if (msg.what == RESETPLATBACKSTATE) {
                updateCurPlayTime(0);
...
//                mPlayBarLayout.setVisibility(View.INVISIBLE);
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mPlayerLayout = rootView.findViewById(R.id.player_layout);
        mLiveWindow = rootView.findViewById(R.id.liveWindow);
        mDrawRect = rootView.findViewById(R.id.draw_rect);
        mPlayBarLayout = rootView.findViewById(R.id.playBarLayout);
        mPlayButton = rootView.findViewById(R.id.playLayout);
        mPlayImage = rootView.findViewById(R.id.playImage);
        mCurrentPlayTime = rootView.findViewById(R.id.currentPlaytime);
        mPlaySeekBar = rootView.findViewById(R.id.play_seekBar);
        mTotalDuration = rootView.findViewById(R.id.totalDuration);
        mVoiceButton = rootView.findViewById(R.id.voiceLayout);
        mClipImageView = rootView.findViewById(R.id.clip_image_view);
        mTransformView = rootView.findViewById(R.id.transform_view);
...
//        mVoiceButton.setVisibility(mVoiceButtonVisibleState ? View.VISIBLE : View.GONE);
    ...
    private void initDrawRectListener() {
        mDrawRect.setOnTouchListener(new DrawRect.OnTouchListener() {
            ...
            public void onDrag(PointF prePointF, PointF nowPointF) {
                ...
                if (mEditMode == Constants.EDIT_MODE_CAPTION) {
                    ...
                    updateEffectPositionOnDrag(timeLinePointF.x, timeLinePointF.y, mDrawRect.getDrawRect());
        ...
        mTransformView.setOnPipTouchListener(new TransformView.OnTransformTouchEventListener() {
            ...
            public void onScaleAndRotate(float scale, float degree) {
                ...
                float oldScale = transform.get(STORYBOARD_KEY_SCALE_X);
    ...
    private Map<String, Float> getTransform() {
        ...
        StoryboardInfo backgroundInfo = mSelectClipInfo.getBackgroundInfo();
...
//            mPlayBarLayout.setVisibility(View.INVISIBLE);
     ...
     * @param duration       总长度
     */
    public void setmPlaySeekBarMaxAndCurrent(long _playStartPoint, long _mPlayEndPoint, long currentPoint, long duration) {
        mPlayStartPoint = _playStartPoint;
        mPlayEndPoint = _mPlayEndPoint;
