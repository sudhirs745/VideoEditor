package com.glitchcam.vepromei.edit.grallyRecyclerView;
...
//            holder.iv_right.setScaleY(1f);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(final View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.edit_centerimage);
            line_left = itemView.findViewById(R.id.line_left);
            line_right = itemView.findViewById(R.id.line_right);
            iv_left = itemView.findViewById(R.id.addImage_left);
            iv_right = itemView.findViewById(R.id.addImage_right);
        }
    }
}
