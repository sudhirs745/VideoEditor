...
public class GlitchAdapter extends RecyclerView.Adapter<GlitchAdapter.ViewHolder> {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mClickListener != null)
                    mClickListener.onItemClickDown(position);
            }
        });
    }
    ...
    public void setSelectPosAndRefresh(int pos){
        mSelectPos = pos;
    ...
    public interface OnItemClickListener {
        void onItemClickDown(int position);
