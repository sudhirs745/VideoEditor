...
public class Constants {
    ...
    * */
    ...
    //注意这里的参数名称：底层拼写错误了，上层需要保持一致
    public final static String SCALE_X = "Caption SacleX";
...
//    public static final String LICENSE_FILE_URL = "https://vsapi.meishesdk.com" + "/api/authorization/ST/current?" + "appId=com.meishe.videoshow";
    public static final String LICENSE_FILE_URL = "https://vsapi.meishesdk.com" + "/api/authorization/ST/current?" + "appId=com.glitchcam.vepromei";
    /**
     * shared util key
     */
