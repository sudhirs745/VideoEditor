...
public class NvAssetManager implements NvHttpRequest.NvHttpRequestListener, NvsAssetPackageManager.AssetPackageManagerCallback {
    ...
    public void downloadRemoteAssetsInfo(int assetType, int aspectRatio, int categoryId, int page, int pageSize) {
        ...
        m_httpRequest.getAssetList(null, assetType, aspectRatio, categoryId, page, pageSize, sdkVersion, this);
    }
     ...
     * Download online material information
     */
    public void downloadRemoteAssetsInfo(String keyword, int assetType, int aspectRatio, int categoryId, int page, int pageSize) {
        //sdkVersion.majorVersion) + "." + String.valueOf(sdkVersion.minorVersion) + "." + String.valueOf(sdkVersion.revisionNumber);
        String sdkVersion = streamingContext.getSdkVersion().majorVersion + "." + streamingContext.getSdkVersion().minorVersion + "." + streamingContext.getSdkVersion().revisionNumber;
        m_httpRequest.getAssetList(keyword, assetType, aspectRatio, categoryId, page, pageSize, sdkVersion, this);
    }
...
//                Collections.sort(assets, c);
     ...
     */
    private void updateAssetDataListSuccess(int assetType, ArrayList<NvHttpRequest.NvAssetInfo> resultsArray, boolean hasNext, String searchKey) {
        ...
        if (TextUtils.isEmpty(searchKey)) {
            ...
            ArrayList<NvAsset> localAsset = assetDict.get(String.valueOf(assetType));
            if (localAsset == null) {
     ...
     * @return
     */
    private List<NvAsset> buildSearchResult(ArrayList<NvHttpRequest.NvAssetInfo> resultsArray, int assetType) {
    ...
    @Override
    public void onGetAssetListSuccess(ArrayList responseArrayList, int assetType, boolean hasNext, String searchKey) {
