package com.glitchcam.vepromei.utils.asset;
...
import static com.glitchcam.vepromei.utils.asset.NvAsset.ASSET_CAPTION_RICH_WORD;
...
public class NvHttpRequest {
    ...
    public void getAssetList(final String searchKey, int assetType, int aspectRatio, int categoryId, int page, int pageSize, String sdkVersion, NvHttpRequestListener requestListener) {
        Request.Builder requenstBuilder = new Request.Builder();
        requenstBuilder.method("GET", null);
        requenstBuilder.url(getRequestParam(searchKey,assetType, aspectRatio, categoryId, page, pageSize,sdkVersion).toString());
                ...
                if (response != null && response.isSuccessful()) {
                    ...
                    if (localRequestListener != null) {
                        ...
                        if (responseInfo.getErrNo() == 0) {
                            localRequestListener.onGetAssetListSuccess(responseInfo.getList(), localAssetsType, responseInfo.getHasNext(),searchKey);
                        } else {
    ...
    private HttpUrl getRequestParam(String searchKey,int assetType, int aspectRatio, int categoryId, int page, int pageSize,String sdkVersion) {
        try {
            ...
            if(!TextUtils.isEmpty(searchKey)){
                ...
                builder.addQueryParameter("keyword", searchKey);
            }
    ...
    public interface NvHttpRequestListener {
        void onGetAssetListSuccess(ArrayList responseArrayList, int assetType, boolean hasNext,String searchKey);
