...
public class ParameterSettingActivity extends BaseActivity {
    ...
    protected void initViews() {
        ...
        mCapture_ratio_sex = findViewById(R.id.capture_ratio_sex);
        mCapcture_ratio_1080 = findViewById(R.id.capture_ratio_1080);
        mCapcture_ratio_720 = findViewById(R.id.capture_ratio_720);
        mOut_ratio_sex = findViewById(R.id.out_ratio_sex);
        mOut_ratio_4k = findViewById(R.id.output_ratio_4k);
        mOut_ratio_1080 = findViewById(R.id.output_ratio_1080);
        mOut_ratio_720 = findViewById(R.id.output_ratio_720);
        mOut_ratio_540 = findViewById(R.id.output_ratio_540);
        mOutput_bitrate_editText = findViewById(R.id.output_bitrate_editText);
        mEncoder_support = findViewById(R.id.encoder_support);
        mBackgroud_blur = findViewById(R.id.backgroud_blur);
        mServiceAgreement = findViewById(R.id.serviceAgreement);
        mPrivacyPolicy = findViewById(R.id.privacyPolicy);
        mSDKVersion = findViewById(R.id.sdkVersion);

        mServiceAgreement.setVisibility(View.GONE);
