...
import com.glitchcam.vepromei.bean.RecordInfo;
import com.glitchcam.vepromei.bean.makeup.BeautyData;
import com.glitchcam.vepromei.bean.makeup.ComposeMakeup;
import com.glitchcam.vepromei.bean.makeup.CustomMakeup;
import com.glitchcam.vepromei.bean.makeup.NullBeautyItem;
...
/**
 * @Class: com.glitchcam.vepromei.capture.CaptureDataHelper.java
...
public class CaptureDataHelper {
    ...
    public ArrayList<BeautyData> getCustomMakeupDataList(Context context) {
        String path = ASSETS_MAKEUP_COSTOM_PATH;
        if (BuildConfig.FACE_MODEL == 240) {
            path = ASSETS_MAKEUP_COSTOM_PATH_240;
        }
        ArrayList<BeautyData> result = getMakeupDataFromAssets(context, path, new ParseFunction<CustomMakeup>() {
            @Override
    ...
    public ArrayList<BeautyData> getComposeMakeupDataList(Context context) {
        ...
        if (BuildConfig.FACE_MODEL == 240) {
            path = ASSETS_MAKEUP_COMPOSE_PATH_240;
        }
        ArrayList<BeautyData> result = getMakeupDataFromAssets(context, path, new ParseFunction<ComposeMakeup>() {
            @Override
